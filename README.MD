...
- "test" wird als external erkannt-> kein arg sondern neuer cmd in expressions. // vlt neue is_cmd oder isexternal
- export muss ich noch fixen.
- Fix args: don't interpret commands
